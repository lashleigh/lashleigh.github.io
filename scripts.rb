...
def write_post_scaffold_file(book, where = '_books/autogenerated')
...
def read_book_data_and_convert_to_json(file = "./_data/goodreads_library_export_1.csv", after)
  puts "after should be a string formatted like '2017-06-01'" unless after.is_a?(String)
...
def write_draft_posts(books, after)
